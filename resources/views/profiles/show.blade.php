...
<div class="row">
  <div class="profile-details col-md-6 offset-md-3 px-0">
      ...
      <p class="profile-item"><i class="fa fa-home mr-2" aria-hidden="true"></i><span class="profile-item-label mr-2">Habite à :</span> {{$user->profile->location}}</p>
...
<div class="row  justify-content-center">
  <div class="col-md-6  px-0 mt-4 text-center">
  <a class="btn btn-outline-dark" href="{{ route('profile.edit') }}">
